...
//***********************************************
// MODULO PARA CALCULAR PORCENTAJE DE DESCUENTO
//***********************************************
SubProceso calcular_porc_dcto (cant, descuento Por Referencia, conver_dsc Por Referencia)
	...
	conver_dsc = porc_dsc // se crea para convertir el descuento y mostrarlo
...
//***********************************************
//    MODULO PARA CALCULAR MONTO DE DESCUENTO
//***********************************************
SubProceso calcular_mto_dsc(monto_descuento Por Referencia, monto_compra, descuento)
	monto_descuento = monto_compra * descuento	
FinSubProceso //calc_mto_pagar
...
Algoritmo fabrica_franelas
	...
	calcular_porc_dcto(cant, descuento, conver_dsc)
	...
	calcular_mto_dsc(monto_descuento, monto_compra, descuento)
	...
	calcular_porc_dcto(cant2, descuento2, conver_dsc2)
	...
	calcular_mto_dsc(monto_descuento2, monto_compra2, descuento2)
